<?php
    ...
    try {
        ...
        $foto_header = !empty($u_data['usr_foto']) ? "../../assets/uploads/perfiles/".$u_data['usr_foto'] : '../../assets/img/usuario.png';
    } catch (Exception $e) {
        $foto_header = '../../assets/img/usuario.png';
    }
?>
<!DOCTYPE html>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center gap-6">
                <button class="relative p-2 text-[#656c89] hover:text-[#385cb4] transition-colors">
                ...
                <div class="relative">
                    ...
                    <div id="profileMenu" class="hidden absolute right-0 mt-3 w-52 bg-white border border-gray-100 rounded-xl shadow-xl py-2 z-50">
                        ...
                        <a href="../controller/ControllerLogout.php" class="flex items-center gap-3 px-4 py-2 text-sm text-red-500 hover:bg-red-50 transition font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
