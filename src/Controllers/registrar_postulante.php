<?php
    ...
    if ($resultado && ($resultado['success'] === true || $resultado['success'] === 't')) {
        ...
        if ($user_data) {
            ...
            header("Location: ../../views/postulante/registro.php");
            exit();
        }
    } else {
        header("Location: ../../views/postulante/registro.php?status=exists");
        exit();
    }
} catch(Exception $e) {
    header("Location: ../../views/postulante/registro.php?status=error");
    exit();
}
