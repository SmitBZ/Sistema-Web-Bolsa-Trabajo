    ...
    <div class="bg-white rounded-2xl shadow-2xl w-[400px] max-w-lg z-10 overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <div class="p-8 space-y-4">
            <div class="text-center space-y-1">
                ...
                <h1 class="text-2xl font-black text-gray-800 uppercase tracking-tightert">Crea tu cuenta</h1>
                <p class="text-xs text-gray-400 font-bold uppercase tracking-widest mt-1">¡Únete a miles de profesionales!</p>
            </div>
